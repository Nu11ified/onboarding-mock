...
export const NON_LOGIN_FLOW: FlowStep[] = [
  ...
  // Step 2: Assistant asks for email
  {
    id: 'email-prompt',
    actor: 'assistant',
    message: 'Sure, we can add a machine to view its sensors. But first, provide your email address so we can save your session.',
    widget: {
      type: 'email-form',
    },
  ...
  // Step 4: Request OTP
  {
    id: 'otp-prompt',
    actor: 'assistant',
    message: 'You should have received the OTP on your email. Please provide the OTP.',
    widget: {
      type: 'otp-form',
    },
    waitForUserInput: true,
...
export const POST_LOGIN_FLOW: FlowStep[] = [
  ...
  // Step 2: Dashboard shown
  {
    id: 'dashboard-shown',
    actor: 'assistant',
    message: 'Now that you have a dashboard displaying live data, would you like to add additional users to view it alongside you?',
  ...
  // Step 3: Ask for emails directly in chat (comma-separated)
  {
    ...
    actor: 'assistant',
    message: 'Please provide email address(es), comma-separated, to invite users (e.g., user1@company.com, user2@company.com).',
    action: 'add-users',
    waitForUserInput: true,
  ...
  // Step 6: Ask about notifications
  {
    ...
    actor: 'assistant',
    message: 'Do you want to get email notifications when a ticket is auto generated/created?',
    widget: {
  ...
  // Step 8: Ask about test ticket
  {
    ...
    actor: 'assistant',
    message: 'Would you like to create a test ticket to confirm that notifications are working as expected?',
    waitForUserInput: true,
  ...
  // Guided graph switching
  {
    ...
    actor: 'user',
    message: 'Can I switch the channel graphs being shown to display the Speed Sensor instead of the Gyro Sensor?',
  ...
  // Guided metric deep-dive
  {
    ...
    actor: 'user',
    message: 'Show vibration trend and temperature stability for the last 7 days.',
    nextStepId: 'guided-metrics-trend-answer',
  },
  {
    id: 'guided-metrics-trend-answer',
    actor: 'assistant',
    message: 'Here are the vibration and temperature line graphs for the last 7 days.',
  ...
  },
  {
    ...
    actor: 'assistant',
    message: (context) => `Correlation is ${typeof (context as any).correlation === 'number' ? (context as any).correlation : 0.58}. Would you like a scatter plot?`,
  ...
  },
  {
    ...
    actor: 'assistant',
    message: 'The top factors are elevated vibration and longer cycle duration during shifts 2–3.',
  ...
  },
  {
    ...
    actor: 'assistant',
    message: (context) => (context as any).comparisonSummary || 'Line B shows 12% higher vibration variance; would you like a side-by-side chart?',
...
export const LOGGED_IN_FLOW: FlowStep[] = [
  ...
  // Step 2: Profile selection prompt
  {
    ...
    actor: 'assistant',
    message: 'Got it. Do you want to use an existing asset profile or create a new one?',
    widget: {
    ...
    waitForUserInput: true,
    nextStepId: (context: FlowContext) => 
      context.profileKey && context.profileConfig?.profileName ? 'existing-profile-selected' : 'new-profile-form',
  },
  ...
  // New profile path
  {
    id: 'new-profile-form',
    actor: 'assistant',
    message: 'Great! Let\'s create a new asset profile. Please fill out the form below as best you can!',
    widget: {
      type: 'profile-config-form',
    },
    waitForUserInput: true,
  ...
  
  {
    id: 'payment-prompt',
    actor: 'assistant',
    message: 'Great now please select your payment plan and provide your payment details.',
    widget: {
      type: 'payment-form',
    },
    waitForUserInput: true,
  ...
  
  {
    id: 'payment-received',
    actor: 'assistant',
    message: 'I received your payment information; I will now create your asset profile!',
