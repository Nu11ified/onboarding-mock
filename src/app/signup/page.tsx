  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.push('/dashboard?logged-in=true&onboarded=false');
      } else {
      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <input
                  ...
                  required
                  disabled={isLoading}
                  className="w-full h-12 px-4 bg-white text-slate-900 placeholder-slate-400 rounded-lg border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                />
              </div>
              <div>
                <input
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <div className="relative">
                  <label className="absolute -top-2 left-3 px-1 bg-white text-[10px] text-slate-500">
                    Register as*
                  </label>
                  <select
                    name="registerAs"
                    ...
                    onChange={handleChange}
                    disabled={isLoading}
                    className="w-full h-12 px-4 bg-white text-slate-900 rounded-lg border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all appearance-none cursor-pointer"
                  >
            ...
            {/* Phone */}
            <div className="flex gap-2">
              <div className="flex items-center gap-2 px-3 bg-white rounded-lg border border-slate-200 h-12">
              ...
              <input
                ...
                disabled={isLoading}
                className="flex-1 h-12 px-4 bg-white text-slate-900 placeholder-slate-400 rounded-lg border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
              />
            </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative mt-0.5">
                ...
                />
                <div className="w-5 h-5 border-2 border-slate-300 rounded peer-checked:border-purple-500 peer-checked:bg-purple-500 transition-all">
                  {mailingList && (
              ...
              <span className="text-sm text-slate-600 leading-tight">
                Add my info to mailing list for new products, services and promotions.
              </span>
            </label>
          ...
          <div className="mt-6 text-center">
            <p className="text-slate-600 mb-1">Already have a Launchpad account?</p>
            <Link
              href="/login"
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-slate-400">
              By creating a Launchpad account, you are agreeing to accept our{' '}
              <Link href="#" className="text-purple-500 hover:underline">Terms of Service</Link>
            </p>
          </div>

          <div className="mt-4 text-center text-xs text-slate-400 leading-relaxed">
            <p>
              We are committed to your privacy. MicroAI™ will only use the information you provide to 
